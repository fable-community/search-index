...
* @returns {Map<any, any>}
*/
export function media_mapped_filter_characters(index_file, extra, role, popularity_lesser, popularity_greater, rating) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {Map<any, any>}
*/
export function id_mapped_filter_characters(index_file, extra, role, popularity_lesser, popularity_greater, rating) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = isLikeNone(index_file) ? 0 : passArray8ToWasm0(index_file, wasm.__wbindgen_export_0);
        var len0 = WASM_VECTOR_LEN;
...
export function __wbg_character_unwrap(arg0) {
...
export function __wbg_character_new(arg0) {
...
export function __wbg_media_unwrap(arg0) {
    const ret = Media.__unwrap(takeObject(arg0));
    return ret;
};

export function __wbg_media_new(arg0) {
